/*
Crie uma um programa para trabalhar com estoque de uma loja, o programa deverï¿½
...
public class collection_loja {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.printf("Deseja inserir outro produto? Se sim tecle '1', se não tecle '2'");
			x = ler.nextInt();
		} while (x == 1);
